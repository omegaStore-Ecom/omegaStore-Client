    ...
    return (
      <section className=" h-screen flex items-center">
        <div className="w-full lg:w-6/12 px-4 mx-auto pt-6 ">
          <div className="relative flex flex-col min-w-0 bg-slate-300 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
            <div className="rounded-t mb-0 px-6 py-6">
              ...
              <div className="btn-wrapper text-center">
                <button
                  ...
                  type="button"
                >
                  <BsFacebook className="pr-2 text-3xl text-blue-600" />
                  Facebook{' '}
                </button>
                <button
                  ...
                  type="button"
                >
                  <FcGoogle className="pr-2 text-3xl" /> Google
                </button>
              </div>
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              ...
              <form>
                <div className="relative flex w-full justify-between mb-3">
