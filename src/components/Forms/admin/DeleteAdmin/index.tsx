...
import {useDeleteAdminMutation, useGetAllAdminsQuery} from "../../../../../redux/services/admin";

const DeleteAdmin: React.FC<UpdateProps> = ({ id, setIsOpen }) => {
  const { refetch } = useGetAllAdminsQuery();
  const [deleteDD] = useDeleteAdminMutation();
