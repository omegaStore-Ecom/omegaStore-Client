...
const HeroSection: React.FC<NavBarProps> = ({active}) => {
  return (
    <div className="h-4/5 w-full overflow-hidden">
      <div
        className={`main-container w-full h-full md:block ${
          active ? 'hidden' : ''
        }`}
      >
        <div className="main w-full h-full bg-[#e21339]">
          <div className="min-h-screen relative w-full h-full">
            ...
            <div className="flex h-full w-full flex-col items-center justify-center  relative z-20">
              <h1 className="text-6xl md:text-8xl text-center font-semibold text-white mb-20 shadowDieTwice">
                Sell anything, everywhere
              </h1>
              <p className="text-2xl md:text-3xl font-semibold text-white mb-10 shadowDieTwice">
                Easier, faster, and all from one place.
              </p>
              <div className="flex justify-between md:w-1/4 mt-10">
