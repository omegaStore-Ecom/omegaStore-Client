    ...
    return (
      <footer className="bg-black h-1/2 flex flex-1 items-end">
        <div className="container px-6 py-4 mx-auto">
          ...
          <hr className="h-px my-6 bg-gray-300 border-none text-white" />
